...
def process():
    ...
    net = inception_v3(pretrained=False, num_classes = 5, aux_logits=False).to(device)
...
if __name__ == '__main__':
    ...
    # net.load_state_dict(torch.load(os.path.join(path, net.__class__.__name__ + '-best' + '.pth')))
    # eval(net, val_loader, loss)
    train_losses, train_acces, eval_losses, eval_acces = train(net, loss, train_loader, val_loader, device, epoch, lr)
